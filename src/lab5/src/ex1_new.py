...
def main(args):
  ...
  try:
   ...
   #as a new file 
    ...
    ###input image
    src = cv2.imread("large.jpg", cv2.IMREAD_COLOR)
    ...
    ##threshold setting
    threshold_val = 130 # values below thresholdvalue in script heading
    ...
    ##threshold image
    #text = str( pytesseract.image_to_string(modimg, lang="eng") )
    print (text)
